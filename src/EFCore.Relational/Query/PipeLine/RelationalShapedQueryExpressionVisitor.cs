        ...
        private class RelationalProjectionBindingRemovingExpressionVisitor : ExpressionVisitor
        {
            ...
            protected override Expression VisitBinary(BinaryExpression binaryExpression)
            {
                    ...
                    && parameterExpression.Type == typeof(MaterializationContext))
                {
                    ...
                    _materializationContextBindings[parameterExpression]
                        = _projectionIndexMapping[((ProjectionBindingExpression)newExpression.Arguments[0]).ProjectionMember];
            ...
            protected override Expression VisitExtension(Expression extensionExpression)
            {
                if (extensionExpression is ProjectionBindingExpression projectionBindingExpression)
                {
                    ...
                    return CreateGetValueExpression(
                        _projectionIndexMapping[projectionBindingExpression.ProjectionMember],
                        null,
